const moviesData = [
    {
        ...
        resume:
            "Dans l'Angleterre du 15e siècle, Hal, un prince capricieux et bon à rien, devient un roi puissant lorsqu'il hérite à contrecœur du trône et de ses conflits",
        like: false,
        nbLike: 18,
        comment: 3,
        bookmark: false,
