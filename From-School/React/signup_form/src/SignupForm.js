...
const SignupForm = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      username: Yup.string()
        .min(3, 'User name must be 3 characters or more')
      ...
      <div className="container__child signup__form">
        <form onSubmit={formik.handleSubmit}>
          <div className="form-group">
            ...
            <input className="form-control" type="text" name="username" id="username" placeholder="james.bond" autoFocus
              {...formik.getFieldProps('username')} />
          </div>
          <div className="form-group">
            <label htmlFor="email">Email</label>
            <input className="form-control" type="text" name="email" id="email" placeholder="james.bond@spectre.com"
          ...
          <div className="form-group">
            ...
            <input className="form-control" type="password" name="passwordRepeat" id="passwordRepeat" placeholder="********"
          ...
          <div className="signup__errors">
            {
              ...
              (formik.touched.passwordRepeat && formik.errors.passwordRepeat) ? formik.errors.passwordRepeat : null
              ].filter(element => {
                return element !== null;
              }).join(', ')
            }
          ...
          <div className="m-t-lg">
            <ul className="list-inline">
              ...
              <li>
                <a className="signup__link" href="google.com">I am already a member</a>
              </li>
            </ul>
          </div>
        </form>
