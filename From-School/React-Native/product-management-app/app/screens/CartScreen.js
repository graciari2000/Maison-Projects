                ...
                renderItem={({ item }) => (
                    <View style={colorScheme === 'dark' ? styles.cartItemDark : styles.cartItemLight}>
                        <View style={styles.itemInfo}>
                            <Text style={colorScheme === 'dark' ? styles.itemNameDark : styles.itemNameLight}>{item.name}</Text>
                            <Text style={colorScheme === 'dark' ? styles.itemQuantityDark : styles.itemQuantityLight}>Quantité: {item.quantity}</Text>
                        </View>
